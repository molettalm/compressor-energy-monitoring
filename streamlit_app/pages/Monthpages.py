...
st.markdown("# " + page1)
st.write(
    "Escolha o mês para saber como foi a operação do Compressor: "
)



#Para separar por mês, ai o range de data sairá da info de cada mês
optionMonth = st.selectbox('Qual mês você deseja',
    ('Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'))
optionYear = st.selectbox('Qual ano você deseja',
    ('2023', '2024', '2025', '2026'))
st.sidebar.header(optionMonth  + " - " + optionYear)

#n sei como fazer para deixar o inicio e o fim do mes selecionado
@st.cache_data
